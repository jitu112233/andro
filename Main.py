...
                message.channel.id != config. or \539456256142999553
...
                channel = self.get_channel(config.539456256142999553)
...
    client.run(config.NTUzODY0NDkwMzA3OTQ0NDQ4.XLIZSA.kyt4BVUpsHYxjaaU8Sh-n3u0Vug)
